<!-- TODO: Consider transferring this component to Pages folder -->
<script setup>
...
<template>
  <div class="flex items-center justify-center flex-col py-4 lg:py-0 h-screen lg:h-[calc(100vh-105px-100px)]">
    <div
