...
<template>
  <div class="min-h-screen">
    <div class="min-h-screen flex items-center justify-center flex-col">
      <div class="min-h-[375px] w-full max-w-[90%] sm:max-w-md md:max-w-lg bg-gray-200 rounded-2xl shadow-2xl p-4 sm:p-8 relative ">
        <!-- Background Shapes -->
        <div
      ...
      <router-link to="/" class="inline-block">
        <button class="mt-7 relative z-0 flex items-center gap-2 overflow-hidden rounded-lg border-[1px]
            border-blue-300 px-4 py-2 font-semibold uppercase text-blue-300 transition-all duration-200
            before:absolute before:inset-0 before:-z-10 before:translate-x-[150%] before:translate-y-[150%]
            before:scale-[2.5] before:rounded-[100%] before:bg-blue-300 before:transition-transform
            before:duration-500 before:content-[''] hover:scale-105 hover:text-white
